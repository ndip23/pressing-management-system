        ...
        <header className="sticky top-0 bg-white/80 dark:bg-apple-gray-900/80 backdrop-blur-md z-50 shadow-apple-sm">
            <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
                <Link to="/directory" className="flex items-center space-x-2">
                    ...
                    <span className="text-xl font-bold text-apple-gray-800 dark:text-apple-gray-100">lsmbooker Directory</span>
                </Link>
                ...
                <div className="hidden md:flex space-x-8 items-center">
                    ...
                    <a href="https://lsmbooker.com/add-your-buisness" className="text-sm font-medium hover:text-apple-blue dark:hover:text-sky-300 transition-colors text-apple-gray-600 dark:text-apple-gray-300">
                        Get The Software
                    </a>
                </div>
    ...
    <footer className="bg-apple-blue text-white">
        <div className="container mx-auto px-6 py-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                <div>
                    <h4 className="font-bold text-lg mb-3">lsmbooker Directory</h4>
                ...
                <div className="md:mx-auto">
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li><a href="https://lsmbooker.com/add-your-business" className="text-sky-200 hover:text-white hover:underline">Get The Software</a></li>
                        <li><a href="https://lsmbooker.com/features" className="text-sky-200 hover:text-white hover:underline">Software Features</a></li>
                    </ul>
                </div>
                ...
                <div className="md:text-right">
                    ...
                    <ul className="space-y-2 text-sm">
                        {/* ✅ EXTERNAL LINK */}
                        <li><a href="https://lsmbooker.com/contact" className="text-sky-200 hover:text-white hover:underline">Contact Us</a></li>
                    </ul>
                </div>
            </div>

            <div className="mt-10 pt-6 border-t border-sky-700 text-center text-xs text-sky-300">
                <p>&copy; {new Date().getFullYear()} lsmbooker. All Rights Reserved.</p>
