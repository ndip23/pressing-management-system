...
import { ArrowLeft, Edit3, Printer, DollarSign, MessageSquare, AlertTriangle, CheckCircle2, Clock3, RefreshCw, Trash2 } from 'lucide-react';
...
const OrderDetailsPage = () => {
    ...
    const companyInfo = { name: 'PressFlow Deluxe Cleaners', address: '123 Clean Street, Suite 100, Anytown, ST 54321', phone: '(555) 773-7729', logoUrl: '' };
    ...
    const loadOrder = useCallback(async (showLoadingSpinner = true) => {
        ...
        try {
            ...
            if (data && data._id) {
                ...
                throw new Error('Order data not found for this ID.');
            }
        } catch (err) {
    ...
    if (!order) {
        return <div className="text-center p-6 text-apple-gray-500">Could not display order information.</div>;
    }
            ...
            <div className="print-hide">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        {user?.role === 'admin' && (<Button variant="danger" onClick={handleDeleteOrder} iconLeft={<Trash2 size={16}/>} isLoading={isDeleting} disabled={isDeleting}>Delete Order</Button>)}
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 print-hide">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <Card title="Items in Order (Screen View)" contentClassName="p-4 sm:p-6">
                        ...
                        ) : <p className="text-sm text-apple-gray-500">No items found.</p>}
                    </Card>
