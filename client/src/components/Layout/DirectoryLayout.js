        ...
        <header className="sticky top-0 bg-white/80 dark:bg-apple-gray-900/80 backdrop-blur-md z-50 shadow-apple-sm">
            <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-8 items-center">
                    ...
                    <a href="https://lsmbooker.com/add-your-business" className="text-sm font-medium hover:text-apple-blue dark:hover:text-sky-300 transition-colors text-apple-gray-600 dark:text-apple-gray-300">
                        Get The Software
                    </a>
                </div>
